...
const SLOPE_DIFFERENCE: f32 = BALL_SIZE;
pub const RIGHT_SLOPE_Y: f32 = MIDDLE_SLOPE_Y + SLOPE_DIFFERENCE / 2.0;
pub const LEFT_SLOPE_Y: f32 = MIDDLE_SLOPE_Y - SLOPE_DIFFERENCE / 2.0;
